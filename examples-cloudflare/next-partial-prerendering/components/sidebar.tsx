		...
		<div className="fixed top-0 z-20 flex w-full flex-col border-b border-gray-800 bg-black lg:bottom-0 lg:z-auto lg:w-72 lg:border-b-0 lg:border-r lg:border-gray-800">
			<div className="flex h-14 items-center px-4 py-4 lg:h-auto">
				<div className="group flex w-full items-center gap-x-2.5">
					...
					<h3 className="font-semibold tracking-wide text-gray-400">Partial Prerendering</h3>
				</div>
			</div>
			<button
				type="button"
			...
			>
				<div className="prose prose-sm prose-invert max-w-none space-y-6 px-4 pb-20 text-gray-300">
					<div className="text-gray-400">
						<p>
							<span className="font-bold text-vercel-pink">Pink dots</span> denote artificially delayed
					...
					<ul>
						...
						<li>
							The shell leaves <em>holes</em> where dynamic content (that might be slower) will be streamed in
					...
					<p className="text-gray-400">Try refreshing the page to restart the demo.</p>
				</div>

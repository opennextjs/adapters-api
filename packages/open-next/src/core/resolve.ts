...
>(converter: DefaultOverrideOptions<E, R>["converter"]): Promise<Converter<E, R>> {
 ...
 * @__PURE__
 */
export async function resolveProxyRequest(proxyRequest: OverrideOptions["proxyExternalRequest"]) {
 ...
 * @__PURE__
 */
export async function resolveCdnInvalidation(cdnInvalidation: OverrideOptions["cdnInvalidation"]) {

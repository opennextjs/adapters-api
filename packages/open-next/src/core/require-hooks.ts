...
function overrideReact(config: NextConfig) {
	...
	try {
		addHookAliases([["react/jsx-runtime", require.resolve("react/jsx-runtime")]], "page");
		addHookAliases([["react/jsx-dev-runtime", require.resolve("react/jsx-dev-runtime")]], "page");
	} catch (e) {}

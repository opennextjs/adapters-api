...
export async function defaultHandler(
	...
	try {
		...
		const imageParams = validateImageParams(headers, queryString === null ? undefined : queryString);
...
function validateImageParams(headers: OutgoingHttpHeaders, query?: InternalEvent["query"]) {
...
function computeEtag(imageParams: { href: string; width: number; quality: number }) {

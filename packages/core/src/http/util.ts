...
export const parseHeaders = (headers?: http.OutgoingHttpHeader[] | http.OutgoingHttpHeaders) => {
 ...
 */
export function parseSetCookieHeader(cookies: string | string[] | null | undefined): string[] {
	if (!cookies) {
		return [];
	}
